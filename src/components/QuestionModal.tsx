...
export const QuestionModal: React.FC<QuestionModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl bg-dark-card border border-dark-border rounded-xl shadow-2xl animate-slide-up max-h-[85vh] flex flex-col">
        {/* Header */}
        <div className="p-6 border-b border-dark-border bg-dark-card rounded-t-xl">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              onClick={onClose}
              className="p-1 rounded-md text-dark-muted hover:text-white hover:bg-dark-highlight transition-all"
            >
              <span className="sr-only">Close</span>
              <kbd className="hidden sm:inline-block px-2 py-0.5 text-xs font-mono border border-dark-border rounded bg-dark-bg mr-2">ESC</kbd>
        ...
        <div className="overflow-y-auto p-4 space-y-2 custom-scrollbar bg-dark-bg/30">
            {/* Headers */}
            <div className="grid grid-cols-12 gap-4 px-4 py-2 text-xs font-mono text-dark-muted uppercase tracking-wider">
                <div className="col-span-1 text-center">St</div>
                <div className="col-span-9">Problem</div>
